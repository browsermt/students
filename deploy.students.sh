...
tar -czvf csen.student.base.tar.gz --transform 's,^,csen.student.base/,' config.intgemm8bitalpha.yml model.8bit-finetuned.intgemm8.alphas.bin speed.cpu.intgemm8bitalpha.sh lex.s2t.gz vocab.spm catalog-entry.yml server.intgemm8bitalpha.yml
...
tar -czvf csen.student.tiny11.tar.gz --transform 's,^,csen.student.tiny11/,' config.intgemm8bitalpha.yml model.8bit-finetuned.intgemm8.alphas.bin speed.cpu.intgemm8bitalpha.sh lex.s2t.gz vocab.spm catalog-entry.yml server.intgemm8bitalpha.yml
...
tar -czvf encs.student.base.tar.gz --transform 's,^,encs.student.base/,' config.intgemm8bitalpha.yml model.8bit-finetuned.intgemm8.alphas.bin speed.cpu.intgemm8bitalpha.sh lex.s2t.gz vocab.spm catalog-entry.yml server.intgemm8bitalpha.yml
...
tar -czvf encs.student.tiny11.tar.gz --transform 's,^,encs.student.tiny11/,' config.intgemm8bitalpha.yml model.8bit-finetuned.intgemm8.alphas.bin speed.cpu.intgemm8bitalpha.sh lex.s2t.gz vocab.spm catalog-entry.yml server.intgemm8bitalpha.yml
