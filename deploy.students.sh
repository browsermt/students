...
tar -czvf csen.student.base.tar.gz --transform 's,^,csen.student.base/,' config.intgemm8bitalpha.yml model.intgemm.alphas.bin speed.cpu.intgemm8bitalpha.sh lex.s2t.gz lex.s2t.bin vocab.spm catalog-entry.yml server.intgemm8bitalpha.yml
scp csen.student.base.tar.gz $USER@magni:/mnt/vali0/www/data.statmt.org/bergamot/models/csen/

cd ../csen.student.tiny11
tar -czvf csen.student.tiny11.tar.gz --transform 's,^,csen.student.tiny11/,' config.intgemm8bitalpha.yml model.intgemm.alphas.bin speed.cpu.intgemm8bitalpha.sh lex.s2t.gz lex.s2t.bin vocab.spm catalog-entry.yml server.intgemm8bitalpha.yml
scp csen.student.tiny11.tar.gz $USER@magni:/mnt/vali0/www/data.statmt.org/bergamot/models/csen/

cd ../encs.student.base
tar -czvf encs.student.base.tar.gz --transform 's,^,encs.student.base/,' config.intgemm8bitalpha.yml model.intgemm.alphas.bin speed.cpu.intgemm8bitalpha.sh lex.s2t.gz lex.s2t.bin vocab.spm catalog-entry.yml server.intgemm8bitalpha.yml
scp encs.student.base.tar.gz $USER@magni:/mnt/vali0/www/data.statmt.org/bergamot/models/csen/

cd ../encs.student.tiny11
tar -czvf encs.student.tiny11.tar.gz --transform 's,^,encs.student.tiny11/,' config.intgemm8bitalpha.yml model.intgemm.alphas.bin speed.cpu.intgemm8bitalpha.sh lex.s2t.gz lex.s2t.bin vocab.spm catalog-entry.yml server.intgemm8bitalpha.yml
