...
test -e model.alphas.npz || $MARIAN/marian-decoder $@ \
    ...
    --quiet --quiet-translation --log speed/cpu.newstest2018.log --optimize8 --intgemm-shifted --intgemm-shifted-all --dump-quantmult  2> quantmults
...
$MARIAN/marian-decoder $@ \
    ...
    --beam-size 1 --mini-batch 32 --maxi-batch 100 --maxi-batch-sort src -w 128 \
    --skip-cost --shortlist lex.s2t.gz 50 50 --cpu-threads 1 \
    --quiet --quiet-translation --log speed/cpu.newstest2018.log --optimize8 --intgemm-shifted --intgemm-shifted-all --use-precomputed-alphas
